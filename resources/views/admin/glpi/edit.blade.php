                ...
                <form method="POST" action="{{ route('admin.glpi.update', [$itemtype, $item['id']]) }}" class="px-6 py-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="comment" rows="3"
                                  class="w-full px-3 py-2 text-sm bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-gray-800 dark:text-gray-200 focus:outline-none focus:border-indigo-400 transition resize-none">{{ old('comment', $item['comment'] ?? '') }}</textarea>
                    </div>
